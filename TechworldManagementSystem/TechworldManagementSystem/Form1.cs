...
namespace TechworldManagementSystem
{
    public partial class Form1 : Form
    {
        ...
        {
            string url = "https://localhost:10001/api/Product";
        ...
        {
            string url = "https://localhost:10001/api/Productt" + ProductIdtxt.Text;
            HttpClient client = new HttpClient();
        ...
        {
            string url = "https://localhost:10001/api/Product" + ProductIdtxt.Text;
            HttpClient client = new HttpClient();
            Product p = new Product();
            p.Id = int.Parse(ProductIdtxt.Text);
            p.GlobalId = ProductGlobalIdtxt.Text;
